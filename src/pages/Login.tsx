...
const Login = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      navigate(formData.role === 'host' ? '/host' : '/');
    } catch (error: any) {
        ...
        <div className="bg-white py-6 sm:py-8 px-4 sm:px-10 shadow sm:rounded-lg">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder={formData.role === 'host' ? 'host@example.com' : 'guest@example.com'}
                />
              </div>
            </div>
          ...
          <div className="mt-6">
            ...
            <div className="mt-4 text-center text-xs text-gray-600">
              <p>Host: host@example.com (any password)</p>
              <p>Guest: guest@example.com (any password)</p>
            </div>
          </div>
        </div>
      </div>
