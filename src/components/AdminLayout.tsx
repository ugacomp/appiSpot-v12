...
import { LogOut, Home, Users, UserCircle, Calendar, DollarSign, Wallet, Menu, X, RefreshCcw, Ban, Building2, CheckSquare, UserCog, MessageSquare, Bell } from 'lucide-react';
...
const AdminLayout: React.FC<AdminLayoutProps> = ({ children }) => {
  ...
  const menuItems = [
    ...
    { 
      ...
      description: 'Manage booking cancellations'
    },
    { 
      title: 'Spots', 
      icon: Building2, 
